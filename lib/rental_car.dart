...
var rentalCar = [
  ...
  RentalCar(
    ...
    available: true,
    description:
        "Mercedes-Benz C-Class adalah mobil sedan mewah dengan kinerja yang mengesankan dan fitur keselamatan yang canggih. Dilengkapi dengan mesin turbocharged yang bertenaga, mobil ini dapat memberikan pengalaman berkendara yang menyenangkan dan efisien. Selain itu, Mercedes-Benz C-Class juga dilengkapi dengan sistem keselamatan seperti kamera 360 derajat dan sistem pengereman otomatis, sehingga memberikan rasa aman bagi pengemudi dan penumpang. Jika Anda ingin merasakan kenyamanan dan kemewahan berkendara mobil sedan mewah, Mercedes-Benz C-Class adalah pilihan yang tepat."
        "Mercedes-Benz C-Class adalah mobil sedan mewah dengan kinerja yang mengesankan dan fitur keselamatan yang canggih. Dilengkapi dengan mesin turbocharged yang bertenaga, mobil ini dapat memberikan pengalaman berkendara yang menyenangkan dan efisien. Selain itu, Mercedes-Benz C-Class juga dilengkapi dengan sistem keselamatan seperti kamera 360 derajat dan sistem pengereman otomatis, sehingga memberikan rasa aman bagi pengemudi dan penumpang. Jika Anda ingin merasakan kenyamanan dan kemewahan berkendara mobil sedan mewah, Mercedes-Benz C-Class adalah pilihan yang tepat.",
    images: [
